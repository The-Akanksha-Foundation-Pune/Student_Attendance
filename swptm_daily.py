...
def send_email_notification(stats, academic_year, month_name, processing_time):
    ...
    try:
        ...
        msg['Subject'] = f"SWPTM Daily ETL - {month_name} {academic_year} - Processing Complete"
        
        # Email body
        body = f"""
SWPTM Daily ETL Process Completed Successfully!
...
This is an automated notification from the SWPTM Daily ETL system.
        """
...
def process_daily_data():
    ...
    if df.empty:
        ...
        logging.info("=== Daily SWPTM ETL Process Completed (No Data) ===")
