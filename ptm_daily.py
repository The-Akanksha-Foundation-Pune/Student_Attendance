#!/usr/bin/env python3
"""
Standalone Daily PTM ETL Script
...
def process_daily_data():
    """Process daily PTM data for current month"""
    logging.info("=== Starting Daily PTM ETL Process ===")
    ...
    df['ptm_attendance_data_unique_key'] = df.apply(
        lambda row: generate_ptm_unique_key(row, academic_year, month_name), axis=1
    )
    ...
    logging.info("=== Daily PTM ETL Process Completed ===")
