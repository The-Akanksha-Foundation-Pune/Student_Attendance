#!/usr/bin/env python3
"""
Standalone Historical SWPTM ETL Script
...
def process_historical_data():
    """Process historical SWPTM data for multiple academic years"""
    logging.info("=== Starting Historical SWPTM ETL Process ===")
    ...
    for academic_year in academic_years:
        ...
        for month in months:
            ...
            df['swptm_attendance_data_unique_key'] = df.apply(
                lambda row: generate_swptm_unique_key(row, academic_year, month), axis=1
            )
    ...
    logging.info("=== Historical SWPTM ETL Process Completed ===")
